...
//        if author Exists please delete it
        AuthorEntity deletedAuthorEntity=authorService.deleteAuthor(id);
        return new ResponseEntity<>(authorMapper.mapTo(deletedAuthorEntity), HttpStatus.OK);
    }
}
